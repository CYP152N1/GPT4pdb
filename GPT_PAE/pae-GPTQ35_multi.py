...
def create_template_directory_and_file():
    ...
    # Save the 'output_template.html' file to the 'templates' directory
    ...
    with open(os.path.join(TEMPLATES_DIR, 'output_template.html'), 'w') as f:
...
if __name__ == "__main__":
    ...
    data = {
        ...
        "img_filenames": [
            ...
            f"rank_{rank_number:04d}_metrics_by_rank.png",
        ],
    }
