...
def create_template_directory_and_file():
    ...
    template_file = os.path.join(template_directory, 'template.html')
...
<body>
    ...
    <div class="image-container">
        <div class="image-wrapper">
            <img src="{{ img_filenames[3] }}" alt="{{ img_filenames[3] }}">
        </div>
        <div class="image-wrapper pae-image">
            <img src="{{ img_filenames[2] }}" alt="{{ img_filenames[2] }}">
        </div>
        <div class="image-wrapper sum-image">
            <img src="{{ img_filenames[0] }}" alt="{{ img_filenames[0] }}">
        </div>
        <div class="image-wrapper sum-image">
            <img src="{{ img_filenames[1] }}" alt="{{ img_filenames[1] }}">
        </div>
    </div>
</body>
</html>
